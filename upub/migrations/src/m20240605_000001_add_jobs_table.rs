		...
		manager
			.create_table(
				Table::create()
					...
					.col(ColumnDef::new(Jobs::Published).timestamp().not_null().default(Expr::current_timestamp()))
					.col(ColumnDef::new(Jobs::NotBefore).timestamp().not_null().default(Expr::current_timestamp()))
		...
		manager
			.create_table(
				Table::create()
					...
					.col(ColumnDef::new(Deliveries::Published).timestamp().not_null().default(Expr::current_timestamp()))
					.col(ColumnDef::new(Deliveries::NotBefore).timestamp().not_null().default(Expr::current_timestamp()))
