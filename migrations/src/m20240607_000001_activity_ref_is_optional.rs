...
use crate::m20240524_000002_create_relations_likes_shares::Announces;
...
impl MigrationTrait for Migration {
	async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
		...
		#[cfg(feature = "not-simplified")]
		{
			use crate::m20240524_000002_create_relations_likes_shares::Likes;
			manager
				.alter_table(
					Table::alter()
						.table(Likes::Table)
